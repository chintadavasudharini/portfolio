        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <p className="text-[var(--text-muted)] leading-relaxed mb-4">
              I'm a software engineer and Computer Science graduate focused on the intersection of full-stack development, aws, aiml and data science. I specialize in building web applications using Python, JavaScript, Flask, MySQL, APIs, and AWS.
            </p>
